...
fun task29_1(today: MyDate): MyDate = today.plus(YEAR.times(1)).plus(WEEK.times(1));

fun task29_2(today: MyDate): MyDate = today.plus(YEAR.times(2)).plus(WEEK.times(3)).plus(DAY.times(5));
